    ...
    <main className="scroll-container bg-dark-image">
      <section className="scroll-section bg-dark">
        ...
        <article className="description">
          <h2 className="title">Мы счастливы пригласить  вас на нашу свадебную вечеринку!</h2>
          <p className="text">Этот вечер будет полон стиля, дерзости, свободы, безудержного веселья, танцев, искусства и конечно же, любви.<br/>Ждём вас, чтобы зажечь вместе и сделать этот праздник ярким и незабываемым!</p>
          <div class="mouse"></div>
        </article>
      </section>
      <section className="scroll-section bg-dark">
      ...
      <section className="scroll-section bg-dark">
        <section className="last-layout">
          ...
          <article className="invitation">
            <p className="text">Ответьте, пожалуйста, сможете ли вы присутствовать</p>
            <a 
              href={INVITATION_URL}
              target="_blank"
              className="button"
